...
\section {Softmax regression} \\ 
 -Cho ví dụ là bài toán  xác định ảnh với input là ảnh và output là nhóm mà ảnh được phân vào được biểu diễn dưới dạng vecto xác suất \\
 ví dụ như : \\
 \begin{bmatrix}
1
\\
...
\end{matrix}\right.
\\
Để giải bài toán phân loại ảnh trên ta sẽ tìm basic function g_{1} để chuyển dữ liệu đầu vào thành 1 vecto xác suát \\
